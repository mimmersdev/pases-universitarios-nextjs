...
import { getInstallationStatusLabel, getPassStatusLabel, getPaymentStatusLabel, getStudentStatusLabel, InstallationStatus, Pass, PassStatus, PaymentStatus } from "pases-universitarios";
...
const ViewPassModal = ({ selectedPass, open, onClose }: ViewPassModalProps) => {
    ...
    const getPaymentStatusColor = (paymentStatus: PaymentStatus) => {
        switch(paymentStatus) {
            ...
            case PaymentStatus.Due: return 'warning';
            case PaymentStatus.Overdue: return 'danger';
        }
    };

    const getPassStatusColor = (passStatus: PassStatus) => {
        switch(passStatus) {
            case PassStatus.Active: return 'success';
            case PassStatus.Inactive: return 'default';
        }
    };

    const getInstallationStatusColor = (installationStatus: InstallationStatus) => {
        switch(installationStatus) {
            case InstallationStatus.Installed: return 'success';
            case InstallationStatus.Pending: return 'warning';
        }
    };
        ...
        <Modal
            ...
            footer={
                <div className="flex justify-end gap-2">
                    ...
                    <Button color="primary" onPress={() => router.push(`/install/${selectedPass.universityId}/${selectedPass.uniqueIdentifier}/${selectedPass.careerId}`)}>
                        Ir a Instalación
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <Chip color={getPaymentStatusColor(selectedPass.paymentStatus)} size="sm" variant="flat">
                                    {getPaymentStatusLabel(selectedPass.paymentStatus)}
                                </Chip>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <Chip color={getPassStatusColor(selectedPass.status)} size="sm" variant="flat">
                                    {getPassStatusLabel(selectedPass.status)}
                                </Chip>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <Chip color={getInstallationStatusColor(selectedPass.googleWalletInstallationStatus)} size="sm" variant="flat">
                                    {getInstallationStatusLabel(selectedPass.googleWalletInstallationStatus)}
                                </Chip>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <Chip color={getInstallationStatusColor(selectedPass.appleWalletInstallationStatus)} size="sm" variant="flat">
                                    {getInstallationStatusLabel(selectedPass.appleWalletInstallationStatus)}
                                </Chip>
                            </div>
